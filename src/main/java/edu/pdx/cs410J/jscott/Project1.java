...
/**
 * The main class for the CS410J airline Project. The main method parses the command line input which is expected
...
public class Project1 {
  ...
  public static void main(String[] args) {
    ...
    if(args.length > 10) {
      System.out.println("Error: Unable to enter flight info due to incorrect number of arguments. " +
  ...
  private static void printReadMe() {
    System.out.println("***********************************************\n" +
                       "* README FOR PROJECT ONE: AIRLINE APPLICATION *\n" +
                       "***********************************************\n");
